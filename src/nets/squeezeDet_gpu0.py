...
from nn_skeleton_gpu0 import ModelSkeleton

class SqueezeDet_gpu0(ModelSkeleton):
...
#----------------------------------------------------------------
  ...
  def _quan_fire_layer(self, layer_name, inputs, s1x1, e1x1, e3x3, stddev=0.01,
      freeze=False):
